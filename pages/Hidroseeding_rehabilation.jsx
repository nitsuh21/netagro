...
const ServiceDetails = () => {
  return (
    <Layout>
      <PageBanner pageName={"Hidroseeding / rehabilation"} />
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="service-info-wrapper pr-lg-40 wow fadeInDown">
                <h2 className="title">Hidroseeding / rehabilation</h2>
                <p>
                We offer erosion control methods on construction sites or as
                 an alternative to the traditional process of seed broadcasting. It is very effective on steep slopes and sloping lawns. The advantage of hydroseeding is that large areas can be completed in very short timeframes with quick germination results. You require different vegetation than grass as an end-result,
                 we have a variety of low water requirement plants/groundcovers/creepers that can be used as alternative.
                </p>
                <div className="block-image wow fadeInDown">
                  <img
                    src="assets/images/features/Hydroseeding.jpg"
                    alt="Service Image"
                  />
                </div>
              </div>
