...
const ServiceDetails = () => {
  return (
    <Layout>
      <PageBanner pageName={"Family Drip Irrigation"} />
          ...
          <div className="row">
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="service-info-wrapper pr-lg-40 wow fadeInDown">
                <h2 className="title">Family Drip Irrigation</h2>
                <p>
                Our service on gravity drip irrigation system is designated to achieve effectiveness
                 and efficiency for family small farms. Smallholders using traditional irrigation methods on family plots are met with fundamental challenges in their effort to raise yields and improve crop quality and the key obstacles they are routinely confronted with include uneven distribution of
                 water and nutrients, wasted water due to runoff and evaporation and increased labor requirements.
                </p>
                <div className="block-image wow fadeInDown">
                  <img
                    src="assets/images/features/family_drip.jpg"
                    alt="Service Image"
                  />
                </div>
              </div>
